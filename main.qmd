...
author:
  ...
  - name: Benjamin Charlier
    ...
    url: https://miat.inrae.fr/bcharlier/
    affiliations:
...
#| code-fold: false
#| output: false
for strat in ["majority_voting", "naive_soft", "glad", "dawid_skene_clust[L=5]", "dawid_skene_clust[L=10]"]:
  ! peerannot aggregate ./simus/independent/ -s "{strat}"
utx.run_dawid_skene("./simus/independent")
```
...
results = {
  "majority_voting": [], "naive_soft": [], "glad": [],
  "dawid_skene": [], "dawid_skene_clust[l=5]": [], "dawid_skene_clust[l=10]": []
  }
...
results["NS"] = results["naive_soft"]
results.pop("naive_soft")
...
utx.run_dawid_skene("./simus/independent-imbalanced")
```
...
#| code-fold: false
#| output: false
for strat in ["majority_voting", "naive_soft", "glad", "dawid_skene_clust[L=5]", "dawid_skene_clust[L=6]", "dawid_skene_clust[L=10]"]:
  ! peerannot aggregate ./simus/student_teacher/ -s "{strat}"
utx.run_dawid_skene("./simus/student_teacher")
```
...
results = {"majority_voting": [], "naive_soft": [], "glad": [], "dawid_skene": [], "dawid_skene_clust[l=5]": [],
           "dawid_skene_clust[l=6]": [], "dawid_skene_clust[l=10]": []}
for strategy in results.keys():
...
#| eval: false
#| output: false
utx.run_dawid_skene("./labelme")
for strat in ["majority_voting", "naive_soft", "glad"]:
  ! peerannot aggregate ./labelme/ -s "{strat}"
for strat in ["majority_voting", "naive_soft", "glad", "dawid_skene"]:
...
for strat in ["majority_voting", "naive_soft", "glad", "dawid_skene_clust[L=2]", "dawid_skene_clust[L=5]"]:
  ! peerannot aggregate ./simus/discrete_difficulty/ -s "{strat}"
utx.run_dawid_skene("./simus/discrete_difficulty")
```
```{python}
...
results = {
  "majority_voting": [], "naive_soft": [], "glad": [],
  "dawid_skene": [], "dawid_skene_clust[l=2]": [], "dawid_skene_clust[l=5]": []
  }
for strategy in results.keys():
...
utx.run_dawid_skene("./datasets/birds_audio")
```
```{python}
#| label: tbl-birds
